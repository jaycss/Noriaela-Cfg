...
unordered_map<int, cSkin> cSkinchanger::Skins = unordered_map<int, cSkin>( {
    ...
    make_pair(WEAPON_KNIFE, cSkin(0, -1, KnifeCT, -1, 3, (char*)("finnese!"), 0.0001f)), // Default
    make_pair(WEAPON_KNIFE_T, cSkin(0, -1, KnifeT, -1, 3, (char*)("geekin' lmao"), 0.0001f)), // Default
    // Gloves
    make_pair(GLOVE_CT, cSkin(10053, -1, GloveCT, -1, 3, nullptr, 0.0001f)), //
    make_pair(GLOVE_T, cSkin(10053, -1, GloveT, -1, 3, nullptr, 0.0001f)), //
	// Pistols
    ...
    make_pair(WEAPON_GLOCK, cSkin(38, -1, -1, -1, 0, (char*)("pistol round ak"), 0.0001f)), // Fade
	make_pair(WEAPON_HKP2000, cSkin(211, -1, -1, -1, 0, nullptr, 0.0001f)), // Ocean Foam (P2000)
    make_pair(WEAPON_P250, cSkin(102, -1, -1, -1, 0, (char*)("brrr"), 0.0001f)), // Whiteout
    ...
    make_pair(WEAPON_USP_SILENCER, cSkin(504, -1, -1, 666, 0, (char*)("Watch The Heads"), 0.0001f)), // Kill Confirmed
	// Rifles
    make_pair(WEAPON_AK47, cSkin(302, -1, -1, -1, 0, (char*)("aimbot.cfg"), 0.0001f)), // Vulcan
	make_pair(WEAPON_AUG, cSkin(455, -1, -1, -1, 0, (char*)("Nico Nico Nii"), 0.0001f)), // Akihabara Accept
    make_pair(WEAPON_AWP, cSkin(279, -1, -1, 777, 0, (char*)("faster"), 0.0001f)), // Asiimov
    ...
    make_pair(WEAPON_M4A1, cSkin(695, -1, -1, -1, 0, (char*)("beauty spray"), 0.0001f)), // Neo-Noir
	...
	make_pair(WEAPON_SSG08, cSkin(624, -1, -1, -1, 0, (char*)("offbrand awp"), 0.0001f)), // Dragonfire
